        ...
        <?php foreach ($general_setting_fields as $section_field): ?>
            ...
            <?php if ($section_heading == 'Calendar'): ?>
                ...
                <div class="col-md-12 mb-2 px-4">
                    <div class="row">
                        <div class="col-md-3">
                            <label class="mr-4"><?php _e('Width', 'wpcb_booking'); ?></label>
                        </div>
                        <div class="col-md-2">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <select name="general[width_unit]">
                                        <option value="px" <?php selected($wpcb_setting->get_setting('general', 'width_unit'), 'px'); ?>><?php _e('px', 'wpcb_booking'); ?></option>
                                        <option value="%" <?php selected($wpcb_setting->get_setting('general', 'width_unit'), '%'); ?>><?php _e('%', 'wpcb_booking'); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
            ...
            <?php foreach ($section_field['fields'] as $field): ?>
                <div class="col-md-12 mb-2 px-4">
                    <div class="row">
                        <div class="col-md-3">
                            <label class="mr-4"><?php echo $field['label']; ?></label>
                        </div>
                        <div class="col-md-2">
